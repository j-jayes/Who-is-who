...
subtitle: "CBS Department of Strategy and Innovation Graduate Seminar"
...
1. What is an innovator in this context?

2. How should I classify the publications?
    - e.g. "Contemporary production of saw blades, circular saws, and machine knives" in the example of Karl Lund?

## How were NLP tasks hard before? {visibility="uncounted"}

In the case when you use patent data, a lot of the research on historical questions is done just with the title of the patent and relationships between patent holders. It was difficult to get more information from the text of the patent. 

### How are they easy now?

Now we can use OCR / NLP to get a lot of information from the text of the patent.

## Tips for working with the OpenAI API {visibility="uncounted"}
...
### Use GPT-4 to generate code to communicate with the API / visualize your data

"Great, thank you, Now I want to draw a map of these locations. What I want to do is create a dictionary with name, birthPlace (and coordinates) and jobTitle from the files in data/biographies_augmented, and then draw a map that I can export as jpeg. The map should have dots for birth place"